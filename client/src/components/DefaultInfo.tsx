      ...
      <div className="w-full p-4 flex items-center justify-between  gap-4">
        <div className="w-full h-full grid  grid-cols-3 gap-2">
          ...
          <span className="col-span-3 flex flex-col justify-center gap-1">
            ...
            <h1 className="text-clamp border-b border-red-300">{`${seletedStudent?.address.Street_name} ${seletedStudent?.address.baranggay} ${seletedStudent?.address.city} ${seletedStudent?.address.province} ${seletedStudent?.address.region} ${seletedStudent?.address.postal_code}`}</h1>
          </span>
        </div>
